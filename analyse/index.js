...
//     //         let {totalWeight, signalWeight, previousSignalWeight, previousIsMandatory, stopCheck, indicatorsResult} = signalResult;
//     //         if (!stopCheck) {
//     //             if (check) {
//     //                 if (!previousIsMandatory || (previousIsMandatory && previousSignalWeight)) {
//     //                     signalWeight += indicatorCheckers[indicator]({weight, ticker, depth, signal, longSignal});
//     //                     totalWeight += weight;
//     //                     previousIsMandatory = mandatory;
//     //                     indicatorsResult[indicator] = Boolean(signalWeight);
//     //                 } else {
//     //                     stopCheck = true
//     //                 }
//     //             }
//     //         }
//     //         return {totalWeight, signalWeight, previousSignalWeight, previousIsMandatory, stopCheck, indicatorsResult};
//     //     }, {
//     //         totalWeight: 0,
//     //         signalWeight: 0,
